...
Este é o segundo caso operacional da formação. É uma utilização verde/amarela — redigir uma resposta institucional com apoio do Copilot.

### Cenário

A Helena Albuquerque recebeu um e-mail de uma estudante a pedir informação sobre a emissão de uma certidão de conclusão de curso. A estudante quer saber:

- que documentos precisa de entregar;
- qual o prazo de emissão;
- qual o custo;
- se pode pedir online.

A Helena precisa de redigir uma resposta clara, completa e com tom institucional.

### Como usar o Copilot no Outlook

No Outlook, ao responder a um e-mail, o Copilot pode ajudar de duas formas:

1. **Botão "Redigir com Copilot"** — gera um rascunho de resposta com base no e-mail original
2. **Ajustar rascunho** — depois de gerar, permite ajustar tom, comprimento e conteúdo

A Microsoft recomenda indicar ao Copilot: a audiência, o propósito e o tom pretendido.
...
> *Redige uma resposta institucional a esta estudante.*
>
> *Objetivo: informar sobre o processo de emissão de certidão de conclusão de curso.*
>
> *Incluir: documentos necessários, prazo estimado de emissão, custo e informação sobre pedido online.*
>
> *Tom: cordial, claro e profissional.*
>
> *Formato: resposta de e-mail com saudação, corpo estruturado e fecho formal.*
>
> *Regras: não acrescentar informação que não esteja confirmada. Se algum dado não estiver disponível, indicar que a estudante deve contactar o serviço para confirmação.*
>
> *Escreve em português de Portugal.*

### Iteração — ajustar o resultado

Depois do primeiro rascunho, testar:

> *Torna a resposta mais curta — máximo 8 linhas.*

> *Adiciona uma frase a indicar que o prazo pode variar em período de exames.*

> *Reescreve com tom mais formal — esta resposta pode ser usada como modelo.*

> *Cria uma versão alternativa para o caso de a estudante ainda ter propinas em dívida — indicando que a certidão só pode ser emitida após regularização.*

### O que validar antes de enviar

- A informação está correta? (comparar com os procedimentos reais do serviço)
- Há dados inventados pelo Copilot?
- O tom é adequado?
- A resposta cobre todas as perguntas da estudante?
- Há informação que não deveria ser incluída?

> O Copilot redige o rascunho. A responsabilidade pelo que se envia é do funcionário que assina.
