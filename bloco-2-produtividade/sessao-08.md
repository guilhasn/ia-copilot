...
{: .note }
> **A língua é vossa — e o Copilot traduz.** Uma das coisas úteis: o Copilot **traduz a apresentação** para outra língua. Precisam de uma **versão em inglês** para um público internacional, ou de devolver a português um documento que veio noutra língua? Basta pedir. O reverso da medalha é que ele pode sair em inglês **sem querer** (a qualidade do modelo é mais alta em inglês e o *Designer* só é fiável em *en-US*) — por isso, quando querem português, peçam-no **explicitamente: "em português europeu"**. Numa língua ou na outra, a régua é a mesma: confirmem o que sai.
