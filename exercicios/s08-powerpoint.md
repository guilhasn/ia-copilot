...
# Exercícios da Sessão 8 — do documento à apresentação (PowerPoint)

> Três exercícios sobre a mesma ideia: **o Copilot gera a apresentação; vocês respondem pelo que lá fica**. O **Exercício 1** (o núcleo) gera uma apresentação a partir de um documento e **valida-a com a fonte**; o **Exercício 2** impõe a estrutura de uma reunião; o **Exercício 3** trata a identidade institucional e os limites do que sai de fábrica. Façam o Exercício 1 no tempo da sessão; os outros ficam para praticar. O método vale para qualquer documento que tenha de ir a slides.
...
{: .note }
> Não há "apresentação certa" escrita aqui — o que o Copilot devolve varia (número de slides, ordem, aspeto). O que conta é **confrontar o que sair com o documento**.
...
**O problema:** a síntese da carga docente do semestre está fechada — preparou-a uma colega de outro serviço — e a Direção quer slides para a reunião. O Copilot gera a apresentação em segundos, mas tu não levas um rascunho à reunião sem o confrontar com a fonte: um slide que perde um risco, ou que inventa um número, leva-te a dizer à Direção algo que o documento não dizia.
...
**3. Confrontar slide a slide** — a apresentação (ou o texto dos slides) ao lado do `.docx`, com as três perguntas:

> *Confere esta apresentação com o documento: (a) alguma conclusão, risco ou recomendação do documento ficou de fora? (b) algum slide diz algo com mais força do que o documento? (c) há algum número, ano ou percentagem nos slides que não esteja no documento? Lista cada caso.*

{: .discussao }
> Para discutir — com resposta verificável no documento:
>
> 1. A apresentação trouxe as **três** recomendações da síntese, ou perdeu alguma?
>
> 2. Algum número nos slides **não aparece** no documento?
>
> 3. O departamento apontado como mais pressionado na apresentação é o mesmo do documento?

<details markdown="1">
<summary>A verdade da fonte — para confrontar com a apresentação</summary>

Estes factos estão no `DOC_S08_Sintese_Carga_Docente.docx` (a régua; o que o Copilot gera, varia):

- **A tabela por departamento** (a régua dos números): Informática **119%** · Matemática **111%** · Gestão **107%** — confirmem que a apresentação não troca nem inventa nenhum destes.
...
- **As três recomendações** (têm de estar **todas** na apresentação): (1) acompanhar individualmente o docente em sobrecarga crítica; (2) reequilibrar a distribuição de horas em Informática antes do próximo semestre; (3) validar necessidades de contratação ou redistribuição com base nos indicadores.

- **Os dois riscos:** o desgaste do caso crítico; a margem reduzida para absorver novas unidades curriculares.

**Confrontar:** cada afirmação da apresentação aponta para uma frase do documento? Faltou uma recomendação (**perda**)? Algum *"pode"* virou *"vai"* (**deriva**)? Apareceu um número que não está no `.docx` (**invenção**)? Sem frase na fonte que a sustente, é palpite do Copilot.

</details>

**Para ir mais longe** *(para quem domina o Copilot):*

- **O teste do espelho:** peçam ao Copilot para **resumir a própria apresentação numa frase** e comparem-na com a vossa tese do passo 1. Se não baterem certo, a apresentação está a contar outra história.
...
- **Gerar duas vezes:** gerem a apresentação **duas vezes** com o mesmo pedido; onde as duas discordarem num número ou numa ênfase, é candidato a invenção ou deriva — a própria variação denuncia o que não está na fonte.
...
**O problema:** a apresentação saiu com um visual genérico — e talvez com inglês a fugir. A identidade da instituição não vem de fábrica.

**1. Tema vs *template*.** O Copilot aplica um **tema** (cores e tipos de letra que ele escolhe). Isso **não** é o ***template*** institucional (o modelo aprovado da vossa IES, com logótipo e paleta próprios). Identifiquem o que teriam de trocar para a apresentação ser "da casa".
...
**3. Listem os limites.** Em três pontos, escrevam o que uma apresentação gerada **nunca** traz de fábrica e que é trabalho vosso: o *template*/logótipo certo, a mensagem da reunião, e o que não se pode pôr por escrito.

{: .discussao }
> Para discutir:
>
> 1. Nesta apresentação, o que é **tema** e o que seria **template**?
>
